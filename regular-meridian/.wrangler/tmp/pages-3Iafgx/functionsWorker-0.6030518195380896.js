...
var onRequestPost = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    while (!isUnique && attempts < maxAttempts) {
      ...
      const { results: results2 } = await context.env.DB.prepare("SELECT id FROM leaderboard WHERE handle = ? LIMIT 1").bind(submissionHandle).all();
    ...
    if (!isUnique) {
      submissionHandle = `Player${Math.floor(Math.random() * 1e6)}`;
    }
...
// C:/Users/rapak/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/rapak/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
